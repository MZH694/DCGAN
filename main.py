...
flags.DEFINE_integer("input_height", 48, "The size of image to use (will be center cropped). [108]")
...
flags.DEFINE_string("dataset", "pattern", "The name of dataset [celebA, mnist, lsun]")
